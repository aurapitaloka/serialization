 ...
 */
public class ManagerPengaturan implements Serializable {
    ...
    public static void setFONT_SIZE(int FONT_SIZE) {
        ManagerPengaturan.FONT_SIZE = FONT_SIZE;
    }
    ...
    public static void setTEXT_COLOR(Color TEXT_COLOR) {
        ManagerPengaturan.TEXT_COLOR = TEXT_COLOR;
    }
    

    private transient Preferences preferences; // transient to exclude from serialization

    public ManagerPengaturan() {
        preferences = Preferences.userNodeForPackage(ManagerPengaturan.class);
    }
